...
class MiniCListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MiniCParser#init_declarator.
    def enterInit_declarator(self, ctx:MiniCParser.Init_declaratorContext):
        pass

    # Exit a parse tree produced by MiniCParser#init_declarator.
    def exitInit_declarator(self, ctx:MiniCParser.Init_declaratorContext):
        pass
    ...
    # Enter a parse tree produced by MiniCParser#printf_statement.
    def enterPrintf_statement(self, ctx:MiniCParser.Printf_statementContext):
        pass

    # Exit a parse tree produced by MiniCParser#printf_statement.
    def exitPrintf_statement(self, ctx:MiniCParser.Printf_statementContext):
        pass


    # Enter a parse tree produced by MiniCParser#printfArgIdent.
    def enterPrintfArgIdent(self, ctx:MiniCParser.PrintfArgIdentContext):
        pass

    # Exit a parse tree produced by MiniCParser#printfArgIdent.
    def exitPrintfArgIdent(self, ctx:MiniCParser.PrintfArgIdentContext):
        pass


    # Enter a parse tree produced by MiniCParser#printfArgInt.
    def enterPrintfArgInt(self, ctx:MiniCParser.PrintfArgIntContext):
        pass

    # Exit a parse tree produced by MiniCParser#printfArgInt.
    def exitPrintfArgInt(self, ctx:MiniCParser.PrintfArgIntContext):
        pass


    # Enter a parse tree produced by MiniCParser#printfArgChar.
    def enterPrintfArgChar(self, ctx:MiniCParser.PrintfArgCharContext):
        pass

    # Exit a parse tree produced by MiniCParser#printfArgChar.
    def exitPrintfArgChar(self, ctx:MiniCParser.PrintfArgCharContext):
        pass
    ...
    # Enter a parse tree produced by MiniCParser#binaryExpr.
    def enterBinaryExpr(self, ctx:MiniCParser.BinaryExprContext):
        pass

    # Exit a parse tree produced by MiniCParser#binaryExpr.
    def exitBinaryExpr(self, ctx:MiniCParser.BinaryExprContext):
        pass
