...
# =============================================================================
    ...
    def visitParenPrimary(self, ctx: MiniCParser.ParenPrimaryContext):
        ...
        self.tipos[ctx] = self._tipo(ctx.expression().binary())
        return None
    ...
    def visitCallPrimary(self, ctx: MiniCParser.CallPrimaryContext):
        ...
        args        = arg_list.binary() if arg_list else []
...
# =============================================================================
    ...
    def _visitar_atribuicao(self, ctx, op):
        ...
        tipo_var = info['tipo']
        tipo_dir = self._tipo(ctx.binary())
    ...
    def visitExpression(self, ctx: MiniCParser.ExpressionContext):
        # Expression é sempre um binary: herda seu tipo
        self.visitChildren(ctx)
