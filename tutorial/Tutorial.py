# Generated from Tutorial.g4 by ANTLR 4.13.2
from antlr4 import *
...
def serializedATN():
    return [
        ...
        0,5,1,0,0,0,1,7,1,0,0,0,3,10,1,0,0,0,5,15,1,0,0,0,7,8,3,3,1,0,8,
...
class Tutorial(Lexer):
    ...
    ruleNames = [ "NUMBER", "NUM", "WS" ]

    grammarFileName = "Tutorial.g4"
