"""
main.py
Programa principal: instancia léxico, sintático e o avaliador (VISITOR).
...
def avaliar(expressao: str) -> float:
    ...
    # 3. Avaliador - padrão VISITOR
    avaliador = AvaliadorExpressoes()
    return avaliador.visit(arvore)
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        print("Avaliador de Expressões (VISITOR) – ANTLR4")
